            ...
            return session
                ...
                .tryMap { (data, response) in
                    ...
                    do {
                        ...
                        if let rawProxyError = try? decoder.decode(RawProxyErrorResponse.self, from: interceptedData ?? data) {
                            throw rawProxyError.asProxyErrorResponse().error
                        } else if let decoded = try? decoder.decode(APIErrorResponse.self, from: interceptedData ?? data) {
                            throw decoded
                        } else {
                            throw error
                        }
